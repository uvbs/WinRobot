...
DWORD
ZapAppIDLaunchACL (LPTSTR AppID)
{
    TCHAR   keyName [256];
    ...
    return ZapNamedValueSD (HKEY_CLASSES_ROOT, keyName, TEXT("LaunchPermission"));
}
    ...
    )
{
    if (SetPrincipal)
    {
        ...
        return AddPrincipalToNamedValueSD (HKEY_LOCAL_MACHINE, TEXT("Software\\Microsoft\\Ole"), TEXT("DefaultAccessPermission"), Principal, Permit,!!PermissionMask);
    } else
    ...
    )
{
    if (SetPrincipal)
    {
        ...
        return AddPrincipalToNamedValueSD (HKEY_LOCAL_MACHINE, TEXT("Software\\Microsoft\\Ole"), TEXT("DefaultLaunchPermission"), Principal, Permit,!!PermissionMask);
    } else
    ...
    )
{
    ...
    if (SetPrincipal)
    {
        ...
        return AddPrincipalToNamedValueSD (HKEY_CLASSES_ROOT, keyName, TEXT("AccessPermission"), Principal, Permit,!!PermissionMask);
    } else
    ...
    )
{
    ...
    if (SetPrincipal)
    {
        ...
        return AddPrincipalToNamedValueSD (HKEY_CLASSES_ROOT, keyName, TEXT("LaunchPermission"), Principal, Permit,!!PermissionMask);
    } else
